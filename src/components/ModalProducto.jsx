...
const ModalProducto = () => {
    ...
    return (
        <Transition.Root show={ modalFormularioNota } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={ handleModalNota}>
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            >Cantidad de Kg a despachar</label>
                                            ...
                                            <input 
                                                ...
                                                id='cantKg'
                                                placeholder='Ingrese cantidad a despachar'
                                                value={cantKg}
                                                onChange={e => {
                                                    setCantKg(parseFloat(e.target.value))
                                                }}
                                            />
                                        </div>
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <input 
                                                ...
                                                value={precioKg}
                                                onChange={e => {
                                                   setPrecioKg(parseFloat(e.target.value))
                                                }}
                                            />
                                        </div>
                                        ...
                                        <div className='mb-5'>
                                            <label 
                                                className='text-gray-700 uppercase font-bold text-sm'
                                            >Monto total del producto</label>
                                            <p>{montoProducto}$</p>
                                        </div>
